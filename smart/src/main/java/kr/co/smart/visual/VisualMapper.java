...
public interface VisualMapper {
	...
	List<HashMap<String, Object>> getCountHirementByYear(HashMap<String, Object> map); //년도별 채용인원수
	List<HashMap<String, Object>> getCountHirementByMonth(); //월별 채용인원수
	List<HashMap<String, Object>> getCountHirementByYearOfTop3(HashMap<String, Object> map); //TOP3부서 년도별 채용인원수
